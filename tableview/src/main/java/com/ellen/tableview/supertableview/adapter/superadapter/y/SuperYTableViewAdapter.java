...
public abstract class SuperYTableViewAdapter<T extends ItemViewHolder,E extends XYItemViewHolder> extends TableViewAdapter {

    private Context context;

    public SuperYTableViewAdapter(Context context){
